...
const formatOptionLabel = (value: string | undefined): string => {
    if (!value) return '自动';
                    ...
                    {totalCost > 0 && (
                        <Dialog open={isTotalCostDialogOpen} onOpenChange={setIsTotalCostDialogOpen}>
                            ...
                            <DialogContent className='border-neutral-700 bg-neutral-900 text-white sm:max-w-[450px]'>
                                <DialogHeader>
                                    <DialogTitle className='text-white'>总成本摘要</DialogTitle>
                                ...
                                <div key={itemKey} className='flex flex-col'>
                                    <div className='group relative'>
                                        <button
                                            ...
                                            {thumbnailUrl ? (
                                                <Image
                                                    src={thumbnailUrl}
                                                    alt={`${new Date(item.timestamp).toLocaleString()} 生成批次预览`}
                                                    width={150}
                                                    height={150}
                                                        ...
                                                        return (
                                                            <>
                                                                <div className='space-y-1 pt-1 text-xs text-neutral-400'>
                                                                    ...
                                                                    <ul className='list-disc pl-4'>
                                                                        <li>
                                                                            文本输入：${rates.textInputPerMillion} / 100
                                                                            万 token
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            图片输出：${rates.imageOutputPerMillion} /
                                                                            100 万 token
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                    ...
                                    <div className='space-y-1 rounded-b-md border border-t-0 border-neutral-700 bg-black p-2 text-xs text-white/60'>
                                        ...
                                        <p>
                                            ...
                                            {formatOptionLabel(item.quality)}
                                        </p>
                                        <p>
                                            <span className='font-medium text-white/80'>背景：</span>{' '}
                                            {formatOptionLabel(item.background)}
                                        </p>
                                        <p>
                                            <span className='font-medium text-white/80'>审核：</span>{' '}
                                            {formatOptionLabel(item.moderation)}
                                        </p>
