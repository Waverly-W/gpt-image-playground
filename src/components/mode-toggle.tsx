    ...
    return (
        <Tabs
            ...
            <TabsList className='relative grid min-h-12 w-full grid-cols-2 overflow-hidden rounded-full border border-white/15 bg-white/10 p-1 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_16px_36px_rgba(0,0,0,0.35)] backdrop-blur'>
                ...
                <TabsTrigger
                    value='generate'
                    className={`relative z-10 h-10 min-h-0 rounded-full border border-transparent px-4 text-sm font-bold transition-colors duration-200 data-[state=active]:!text-neutral-950 dark:data-[state=active]:!text-neutral-950 ${
